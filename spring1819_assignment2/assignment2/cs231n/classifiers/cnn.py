...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        d_a2, grads['W3'], grads['b3'] = affine_backward(d_a3, a3_cache)
        grads['W3'] += self.reg * W3

        d_a1, grads['W2'], grads['b2'] = affine_relu_backward(d_a2, a2_cache)
        grads['W2'] += self.reg * W2

        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(d_a1, a1_cache)
